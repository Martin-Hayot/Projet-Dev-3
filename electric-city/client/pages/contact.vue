<template>
	<section class="tw-min-h-screen tw-flex tw-flex-col">
		<img
			src="StudioFond.jpg"
		...
		<div class="tw-container tw-max-w-7xl tw-mx-auto tw-px-6 tw-py-6 tw-z-50">
			<nav class="tw-flex tw-items-center tw-justify-between tw-font-bold tw-text-white tw-z-50">
				<NuxtImg
					src="./logo-white-cropped.png"
					class="tw-z-10 tw-h-20 tw-w-44 tw-ml-2 -tw-mt-4"
				></NuxtImg>
				<div class="tw-hidden tw-h-10 tw-font-alata tw-mt-2 md:tw-flex md:tw-space-x-6 tw-z-10">
					<div class="group">
						<NuxtLink
			...
			<div class="tw-text-white tw-text-center tw-my-10 tw-z-40 ">
				<div class="tw-text-4xl tw-font-bold tw-tracking-wide tw-leading-tight tw-font-sans tw-z-10 tw-columns-2">
                    ...
                    <div class="tw-w-full tw-bg-white tw-rounded-lg tw-shadow dark:tw-border md:tw-mt-0 sm:tw-max-w-md xl:tw-p-0 dark:tw-bg-gray-800 dark:tw-border-gray-700 tw-float-right tw-mr-10">
                        <div class="tw-p-6 tw-space-y-4 md:tw-space-y-6 sm:tw-p-8">
                            ...
                            <form class="tw-space-y-4 md:tw-space-y-6" id="form" action="http://localhost:3001/api/messages" method="POST" target="dummyframe">
                                <div>
									<label
                                        for="email"
